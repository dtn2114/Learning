...
class Market(object):
    ...
    def long(self):
        ...
        if self.position == 0: return -1
            ...
            self.position = 0
            return 2*(self.curr[1]['dr'] + (1+self.impact))
        elif self.position == 2:
            self.position = 0
            return 1*(self.curr[1]['dr'] * (1+self.impact))
        else:
            self.position = 2
            return -1
    ...
    def short(self):
        ...
        if self.position == 2:
            self.position =1
            return  2*(self.curr[1]['dr'] * (-1*self.impact + 1))
        elif self.position == 0:
            self.position = 1
            return  1*(self.curr[1]['dr'] * (-1*self.impact + 1))
        elif self.position == 1: return -1
        else:
            self.position = 2
            return -1
    ...
    def hold(self):
        if self.position == 1: return 1 * self.curr[1]['dr']
        elif self.position == 0: return 0
        elif self.position == 2: return -1 *self.curr[1]['dr']
        else:
            self.position = 0
            return -1
